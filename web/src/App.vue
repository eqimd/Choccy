    ...
    <el-container>
      <el-header>
        <el-menu :default-active="router.currentRoute.value.path" class="el-menu-demo" mode="horizontal"
          ...
          <el-menu-item index="/suite">Query Kit</el-menu-item>
          <el-menu-item index="/database">Database</el-menu-item>
          <el-menu-item index="/task">
            <el-badge :value="unread.task" :max="9999" :hidden="unread.task===0" class="item">Task</el-badge>
          </el-menu-item>
          <el-menu-item index="/result">
            <el-badge :value="unread.result" :max="9999" :hidden="unread.result===0" class="item">Analysis results</el-badge>
          </el-menu-item>
...
const openAuth = () => {
  ElMessageBox.prompt('Please enter the system token', '', {
